...
3. **Configura tus credenciales**: 
   ...
   **Opción 100% GRATUITA** (recomendada para comenzar):
   ```bash
   cp .env.example .env
   # Edita .env y solo coloca tu email en MYMEMORY_EMAIL
   ```
   
   **Opción Premium** (con IA de guiones y voces ultra-realistas):
   ```env
